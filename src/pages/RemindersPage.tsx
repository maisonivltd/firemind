...
const initialReminders: Reminder[] = [
  { id: "1", text: "Ricordati che sei una persona disciplinata.", times: ["08:00", "14:00", "21:00"], active: true },
  { id: "2", text: "Concentrati sulle cose importanti.", times: ["09:00", "17:00"], active: true },
  { id: "3", text: "Hai fatto oggi quello che conta?", times: ["20:00"], active: false },
];
        ...
        {showAdd && (
          <div className="rounded-2xl border border-border bg-card p-4 space-y-4 animate-[slide-up_0.3s_ease-out]">
            ...
            <div className="flex gap-2">
              <Button onClick={addReminder} className="warm-gradient-bg flex-1 rounded-xl text-primary-foreground font-bold hover:opacity-90">
                Salva
              </Button>
